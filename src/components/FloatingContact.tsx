import { Headset, Mail, Phone, MessageSquare, X, MessageCircle } from 'lucide-react';
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div 
          ...
          className="fixed bottom-6 md:bottom-8 right-6 md:right-8 z-50 flex flex-col items-end gap-3 pointer-events-none"
        >
          <AnimatePresence>
            {isOpen && (
              <motion.div 
                ...
                className="flex flex-col bg-white dark:bg-[#121212] rounded-[1.5rem] hover:shadow-2xl border border-gray-100 dark:border-gray-800 w-max overflow-hidden pointer-events-auto shadow-xl"
              >
                <div className="flex flex-col p-2">
                  <a href="mailto:info@3ddx.com" className="flex items-center gap-4 px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors rounded-xl group w-full">
                    <div className="bg-[#188DBA]/10 dark:bg-[#188DBA]/20 p-2.5 rounded-full group-hover:bg-[#188DBA] transition-colors shrink-0">
                      <Mail className="w-5 h-5 text-[#188DBA] group-hover:text-white transition-colors" />
                    </div>
                    <span className="font-bold text-sm text-graphite dark:text-gray-200 group-hover:text-[#188DBA] transition-colors whitespace-nowrap pr-4">Email Us</span>
                  </a>
                  ...
                  <a href="tel:617-820-5279" className="flex items-center gap-4 px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors rounded-xl group w-full">
                    <div className="bg-[#188DBA]/10 dark:bg-[#188DBA]/20 p-2.5 rounded-full group-hover:bg-[#188DBA] transition-colors shrink-0">
                      <Phone className="w-5 h-5 text-[#188DBA] group-hover:text-white transition-colors" />
                    </div>
                    <span className="font-bold text-sm text-graphite dark:text-gray-200 group-hover:text-[#188DBA] transition-colors whitespace-nowrap pr-4">Call Us</span>
                  </a>
                  <a href="#" className="flex items-center gap-4 px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors rounded-xl group w-full">
                    <div className="bg-[#188DBA]/10 dark:bg-[#188DBA]/20 p-2.5 rounded-full group-hover:bg-[#188DBA] transition-colors shrink-0">
                      <MessageCircle className="w-5 h-5 text-[#188DBA] group-hover:text-white transition-colors" />
                    </div>
                    <span className="font-bold text-sm text-graphite dark:text-gray-200 group-hover:text-[#188DBA] transition-colors whitespace-nowrap pr-4">Chat With Us</span>
                  </a>
                </div>
              </motion.div>
            )}
          ...
          >
            ...
            >
              {isOpen ? <X className="w-6 h-6 md:w-7 md:h-7" /> : <Headset className="w-6 h-6 md:w-7 md:h-7" />}
            </motion.div>
          </motion.button>
        </motion.div>
      )}
